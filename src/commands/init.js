...
export async function initCommand(opts) {
  ...
  console.log(`  2. Run ${chalk.cyan('npx @fwufewio/mnema learn')} to record your first architectural decision`);
